...
const GLASS = "bg-white/[0.10] backdrop-blur-xl backdrop-saturate-150 border border-white/20";
const INPUT = "w-full bg-white/[0.10] border border-white/15 rounded-lg px-3 py-2.5 text-sm text-white placeholder-white/40 focus:outline-none focus:border-white/40 focus:ring-1 focus:ring-white/25";
