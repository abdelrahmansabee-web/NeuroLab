...
const KinSection = React.memo(function KinSection({ data, demographics, onChange, showToast, sessionKey }) {
  ...
  const KIN_TIPS = {
    ...
    nvp_reach: "Velocity peaks on the reach path from the rest palm landmark through reach end. Same peaks as the overlay NVP dots.",
    ...
    nvp: "NVP on the validation-video panel (peaks from the rest palm landmark through the current/window end). Same number as the NVP chip on the overlay.",
    nvp_reach: "Velocity peaks on the reach path from the rest palm landmark. Total NVP cannot be lower than this.",
    straightness: "Path straightness from the rest palm landmark to the current/window-end palm (displacement / path length).",
