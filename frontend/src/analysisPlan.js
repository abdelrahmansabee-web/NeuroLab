...
export const KINEMATIC_VARS = [
  ...
  { key: "shoulder_elevation_elbow_anchor_ratio", label: "Shoulder elevation / elbow anchor", unit: "ratio", dir: "lower", tier: "secondary" },
...
export const KINEMATIC_DISPLAY_ORDER = [
  ...
  "shoulder_elevation_elbow_anchor_ratio",
...
export const MANUSCRIPT_KINEMATIC_TARGETS = {
  ...
  shoulder_elevation_elbow_anchor_ratio: { pre: 0.25, post: 0.16, healthy: 0.09 },
...
const LEGACY_KIN_MAP = {
  ...
  shoulder_elevation_elbow_anchor_ratio: ["shoulder_elevation_elbow_anchor_ratio"],
...
export function formatKinValue(key, value) {
  ...
  if (key === "shoulder_elevation_table_ratio" || key === "shoulder_elevation_elbow_anchor_ratio") return val.toFixed(3);
