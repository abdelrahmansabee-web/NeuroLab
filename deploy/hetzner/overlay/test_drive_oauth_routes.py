...
class DriveOauthRoutesTests(unittest.TestCase):
    def test_html_uses_auth_prefixed_paths(self) -> None:
        ...
        self.assertIn("connectPath", html)
        self.assertIn("abdelrahmansabee-raedai.hf.space", html)
    ...
    def test_route_decorators_in_source(self) -> None:
        ...
        self.assertIn("connectPath", src)
        self.assertIn("signin", src)
        self.assertIn("/?drive=connected", src)
