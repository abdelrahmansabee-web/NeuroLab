...
class DrivePersistTests(unittest.TestCase):
    ...
    def test_upserts_validation_video_in_patient_folder(self) -> None:
        ...
        self.assertIn("pre_validation_original.mp4", out["files"])
        self.assertIn("pre_validation_overlay.json", out["files"])
        self.assertNotIn("01_demographics.json", out["files"])
        self.assertEqual(out["patientKey"], "105_Ahmet_sever")
        self.assertEqual(len(out["locations"]), 3)
    ...
    def test_drive_keeps_pdf_and_validation_videos_only(self) -> None:
        ...
        self.assertEqual(clinic_drive_filename("pre_validation_original.mp4"), "pre_validation_original.mp4")
        self.assertEqual(clinic_drive_filename("pre_original.mp4"), "pre_validation_original.mp4")
        self.assertEqual(clinic_drive_filename("pre_validation_overlay.json"), "pre_validation_overlay.json")
