(function () {
  ...
  var CSS =
    ...
    "html.nl-clinic-smooth .content-shell{background-color:rgba(24,34,48,0.22)!important}" +
    "html.nl-clinic-smooth .sidebar-shell,html.nl-clinic-smooth .section-header," +
    "html.nl-clinic-smooth .app-topbar-glass{background-color:rgba(24,34,48,0.50)!important}" +
    "html.nl-clinic-smooth .glass-float{background-color:rgba(24,34,48,0.44)!important}" +
    "html.nl-clinic-smooth .gselect-trigger,html.nl-clinic-smooth .gselect-menu{" +
    "background-color:rgba(36,44,56,0.90)!important}";
