...
# UI-aligned — 4 primary + 7 secondary kinematics
PRIMARY_KIN_KEYS = {"nvp", "straightness", "pause_time_sec", "number_of_stops"}
KINEMATIC_PRIMARY = [
...
KINEMATIC_SECONDARY = [
    ...
    ("shoulder_flexion_mean_deg", "Shoulder flexion mean (deg)"),
    ("movement_time_sec", "Movement time (s)"),
    ("peak_elbow_ang_vel_deg_s", "Peak elbow angular velocity (°/s)"),
    ("peak_shoulder_flexion_vel_deg_s", "Peak shoulder flexion velocity (°/s)"),
]
